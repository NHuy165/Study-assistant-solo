...
- The "questions" key is a JSON array containing the main questions of the multiple choice exercise.
- "answers": Do not include letter prefixes (like 'A', 'B', 'C'...). Just the answer text.
- The default number of questions is 10, the default number of answers for each question is 4. This can be changed according to the user's explicit request.
"""
...
Additional information:
- The "contents" key is a JSON array containing the contents of the flashcards. Each flashcard is described by a dictionary containing "front" and "back" information.
