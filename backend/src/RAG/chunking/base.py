...
def save_document_analysis(
    ...
    """
    Validates and saves the document analysis generated by the LLM.
    """
...
def analysis_task_generator(
    ...
    async def perform_analysis() -> DocumentAnalysis:
        """
        Generates a document analysis using the LLM and passes it into the save_document_analysis function.
        """
        i_retry = 0
        while True:
